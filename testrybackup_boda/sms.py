...
class SMS(object):
	...
	def setPinCode(self):
		...
		Set pin Code
		"""
		self._logger.debug("Set the good code pin: xxxx")
		status=self.sendATCmd_WaitResp("AT+CPIN={}".format(pincode),"OK")
		return status==ATResp.OK

		self._logger.debug("Set Pin Code")
		self.sendATCmd_WaitResp("CPIN=8743", "OK")
		status=self.sendATCmd_WaitResp("CPIN", "OK")
		return status==ATResp.OK
